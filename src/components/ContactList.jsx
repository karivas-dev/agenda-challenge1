...
export const ContactList = () => {
    ...
    const toggleFavorite = (id) => {
        setAllContacts(contacts => contacts.map(contact => contact.id === id ? {
    ...
    const deleteContact = (id) => {
        setAllContacts(contacts => contacts.filter(contact => contact.id !== id));
    }

    return (<>
        <Modal isModalActive={showModal} toggleModal={toggleModal} allContacts={allContacts}
        ...
        <div
            ...
            <div className="flow-root">
                <ul className="divide-y divide-gray-400">
                    {allContacts.sort((contact1, contact2) => {
